...
export const TIER_STYLES: Record<string, TierStyle> = {
  ...
  platina: {
    grad: 'linear-gradient(135deg, #F0F5FA 0%, #BDD2E3 40%, #5F86A6 78%, #93AAC4 100%)',
    softGrad: 'linear-gradient(135deg, #EFF4F9 0%, #BDD2E3 100%)',
    fg: '#1F3340', accent: '#5F86A6', bg: '#E5EEF6',
    glow: '0 8px 24px rgba(95,134,166,0.30)',
    badgeFg: '#15242F',
    intensity: 4,
    metalGrad: 'linear-gradient(135deg, #FFFFFF 0%, #BDD2E3 28%, #FFFFFF 48%, #3D6485 70%, #93AAC4 100%)',
    bgFar:  '#E5EEF6',
    bgMid:  '#BDD2E3',
    bgNear: '#84A4BE',
    particle: '#5F86A6',
    ringGlow: 'rgba(95,134,166,0.6)',
  },
  rubi: {
